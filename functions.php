...
function wp_bootstrap_starter_setup() {
	...
	register_nav_menus( array(
		...
		'utility' => esc_html__( 'Utility', 'wp-bootstrap-starter'),
...
function wp_bootstrap_starter_scripts() {
	...
	wp_enqueue_style( 'wp-bootstrap-starter-hiram-font', '//fonts.googleapis.com/css?family=Gravitas+One|Montserrat:400,600|Playfair+Display:700|Roboto+Condensed:400,400i,700,700i', false ); 
    ...
    if(get_theme_mod( 'preset_style_setting' ) === 'montserrat-opensans') {
        wp_enqueue_style( 'wp-bootstrap-starter-montserrat-opensans-font', '//fonts.googleapis.com/css?family=Gravitas+One|Montserrat:600|Playfair+Display:700|Roboto+Condensed:400,400i,700,700i' );
    }
	...
	wp_enqueue_script( 'wp-bootstrap-starter-custom-script', get_template_directory_uri() . '/site.js', array(), '20151215', true );
